...
const Location = () => {
  const handleLocationClick = () => {
    window.open(
      "https://www.google.com/maps/place/Surabaya/@-7.137778,112.730362,15z",
      "_blank"
    );
  };
      ...
      <div className="location-row">
        ...
        <div className="location-info-group">
          <div className="location-address">
            Jl. loremipsum 1 (sebelah warung pak tho), dolor si amet, Surabaya,
            Jawa timur, Indonesia, 61262
          </div>
